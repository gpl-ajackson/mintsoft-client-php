 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ToolkitDataClassesWarehouseZone implements ModelInterface, ArrayAccess
{
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^[^\"'&<>()–]+$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling ToolkitDataClassesWarehouseZone., must conform to the pattern /^[^\"'&<>()–]+$/.");
        }
