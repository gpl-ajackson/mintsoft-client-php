 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ToolkitDataClassesWarehouseLocation implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['simple_location_name']) && !preg_match("/^[^\"'&<>()–]+$/", $this->container['simple_location_name'])) {
            $invalidProperties[] = "invalid value for 'simple_location_name', must be conform to the pattern /^[^\"'&<>()–]+$/.";
        }

        if (!is_null($this->container['location_name']) && !preg_match("/^[^\"'&<>()–]+$/", $this->container['location_name'])) {
            $invalidProperties[] = "invalid value for 'location_name', must be conform to the pattern /^[^\"'&<>()–]+$/.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^[^\"'&<>()–]+$/", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling ToolkitDataClassesWarehouseLocation., must conform to the pattern /^[^\"'&<>()–]+$/.");
        }
    ...
    public function setSimpleLocationName($simple_location_name)
    {
        ...
        if (!is_null($simple_location_name) && (!preg_match("/^[^\"'&<>()–]+$/", $simple_location_name))) {
            throw new \InvalidArgumentException("invalid value for $simple_location_name when calling ToolkitDataClassesWarehouseLocation., must conform to the pattern /^[^\"'&<>()–]+$/.");
        }
    ...
    public function setLocationName($location_name)
    {
        ...
        if (!is_null($location_name) && (!preg_match("/^[^\"'&<>()–]+$/", $location_name))) {
            throw new \InvalidArgumentException("invalid value for $location_name when calling ToolkitDataClassesWarehouseLocation., must conform to the pattern /^[^\"'&<>()–]+$/.");
        }
