<?php
/**
 * ToolkitDataClassesWarehouseProductInLocation
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * ToolkitDataClassesWarehouseProductInLocation Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ToolkitDataClassesWarehouseProductInLocation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Toolkit.DataClasses.Warehouse.ProductInLocation';
    ...
    public function setBatchNo($batch_no)
    {
        if (!is_null($batch_no) && (mb_strlen($batch_no) > 100)) {
            throw new \InvalidArgumentException('invalid length for $batch_no when calling ToolkitDataClassesWarehouseProductInLocation., must be smaller than or equal to 100.');
        }
        if (!is_null($batch_no) && (mb_strlen($batch_no) < 0)) {
            throw new \InvalidArgumentException('invalid length for $batch_no when calling ToolkitDataClassesWarehouseProductInLocation., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param int $inventory_item_id inventory_item_id
     *
     * @return $this
     */
