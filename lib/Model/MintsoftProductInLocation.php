...
/**
 * ProductInLocation Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MintsoftProductInLocation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductInLocation';
    ...
    public function setBatchNo($batch_no)
    {
        if (!is_null($batch_no) && (mb_strlen($batch_no) > 100)) {
            throw new \InvalidArgumentException('invalid length for $batch_no when calling ProductInLocation., must be smaller than or equal to 100.');
        }
        if (!is_null($batch_no) && (mb_strlen($batch_no) < 0)) {
            throw new \InvalidArgumentException('invalid length for $batch_no when calling ProductInLocation., must be bigger than or equal to 0.');
        }
