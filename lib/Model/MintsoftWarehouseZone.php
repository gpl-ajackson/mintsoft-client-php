...
/**
 * ToolkitDataClassesWarehouseZone Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MintsoftWarehouseZone implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Toolkit.DataClasses.Warehouse.Zone';
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^[^\"'&<>()–]+$/u", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling ToolkitDataClassesWarehouseZone., must conform to the pattern /^[^\"'&<>()–]+$/u.");
        }
