...
/**
 * ToolkitDataClassesCurrenciesCurrency Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ToolkitDataClassesCurrenciesCurrency implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Toolkit.DataClasses.Currencies.Currency';
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ToolkitDataClassesCurrenciesCurrency., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ToolkitDataClassesCurrenciesCurrency., must be bigger than or equal to 0.');
        }
    ...
    {
        if ((mb_strlen($code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ToolkitDataClassesCurrenciesCurrency., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $code when calling ToolkitDataClassesCurrenciesCurrency., must be bigger than or equal to 0.');
        }
