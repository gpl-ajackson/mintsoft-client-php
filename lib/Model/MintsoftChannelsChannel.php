 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MintsoftChannelsChannel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/^[^\"'&<>()–]+$/u", $this->container['name'])) {
            $invalidProperties[] = "invalid value for 'name', must be conform to the pattern /^[^\"'&<>()–]+$/u.";
        }

        if (!is_null($this->container['logo']) && !preg_match("/^[^\"'&<>()–]+$/u", $this->container['logo'])) {
            $invalidProperties[] = "invalid value for 'logo', must be conform to the pattern /^[^\"'&<>()–]+$/u.";
        }
    ...
    public function setName($name)
    {
        ...
        if ((!preg_match("/^[^\"'&<>()–]+$/u", $name))) {
            throw new \InvalidArgumentException("invalid value for $name when calling ToolkitDataClassesChannelsChannel., must conform to the pattern /^[^\"'&<>()–]+$/u.");
        }
    ...
    public function setLogo($logo)
    {
        ...
        if (!is_null($logo) && (!preg_match("/^[^\"'&<>()–]+$/u", $logo))) {
            throw new \InvalidArgumentException("invalid value for $logo when calling ToolkitDataClassesChannelsChannel., must conform to the pattern /^[^\"'&<>()–]+$/u.");
        }
